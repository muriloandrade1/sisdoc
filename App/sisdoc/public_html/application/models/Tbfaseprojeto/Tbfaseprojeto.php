...
class Application_Model_Tbfaseprojeto_Tbfaseprojeto {

    protected $_codigo1;
    protected $_codigo2;
    protected $_fasedoprojeto;
    ...
    public function setfasedoprojeto($ds) {
        $this->_fasedoprojeto = $ds;
        return $this;
    }

    public function getfasedoprojeto() {
        return $this->_fasedoprojeto;
    }
