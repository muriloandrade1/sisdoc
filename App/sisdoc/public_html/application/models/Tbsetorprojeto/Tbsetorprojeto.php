...
class Application_Model_Tbsetorprojeto_Tbsetorprojeto {

    protected $_codigo1;
    protected $_codigo2;
    protected $_setordeprojeto;
    ...
    public function setsetordeprojeto($ds) {
        $this->_setordeprojeto = $ds;
        return $this;
    }

    public function getsetordeprojeto() {
        return $this->_setordeprojeto;
    }
